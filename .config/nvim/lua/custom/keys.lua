...
-- Is this the right place for this option?
...
-- Setup all keybinding that are applicable everywhere, regardless of LSPs.
M.setup = function()
 ...
 "<leader>/" ]]
  ...
  -- These are for buffer keymaps, but that is not set up yet.
  ...
  local leader = {
    ...
    wk.register(keymap_visual, { mode = "v", prefix = "i" })
    wk.register(
    {
      a = {"Parameter"},
    },
    { mode = "n", prefix = "vi" })
    wk.register(keymap_goto, { prefix = "g" })
