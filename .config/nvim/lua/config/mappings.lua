...
local leader = {
	...
	f = {
		...
		d = {
			function()
				require("config.dotfilepicker").find_files()
			end,
			"Dotfiles",
		},
	},
	...
	q = {
		...
		L = { [[<cmd>Telescope sessions_picker<cr>]], "List All Sessions" },
		d = { [[<cmd>lua require("persistence").stop()<cr>]], "Stop Current Session" },
	},
	x = {
		name = "+errors",
		x = { "<cmd>TroubleToggle workspace_diagnostics<cr>", "Trouble" },
		d = { "<Cmd>Trouble document_diagnostics<CR>", "Document Trouble" },
		...
		r = { "<Cmd>Trouble lsp_references <CR>", "Open Location List" },
